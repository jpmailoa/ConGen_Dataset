...
data_uri = ['./data_LHCE_Diluent/paper_MP_IE_EA.csv',
            './data_LHCE_Diluent/paper_MP_clean_canonize_cut.csv',
            './data_LHCE_Diluent/paper_ZINC_310k.csv',
            './data_LHCE_Diluent/paper_clean_viscosity.csv',
            './data_LHCE_Diluent/paper_pubchem_fluorocarbon.csv']
